		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-md-8">
					...
					<div class="hidden" data-step="6" data-next="details" data-prev="accom" data-summary-id="accom">
						<?php include("partial_views/accommodation-5.php"); ?>
					</div>
					<div class="hidden" data-step="7" data-next="details" data-prev="accom-part-2" data-summary-id="accom-part-2">
