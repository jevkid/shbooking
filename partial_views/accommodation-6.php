		...
		<div class="col-12">
			<div class="multi-options">
				...
				<div class="option">
					<div class="row">
						<div class="col-12 col-md-3">
							<input type="radio" name="group2-roomoption" checked="checked" data-id="0" value="Captain's Cabin"> <label>Captain's Cabin</label>
				...
				<div class="option">
					<div class="row">
						<div class="col-12 col-md-3">
							<input type="radio" name="group2-roomoption" data-id="1" value="Beethoven's Cabin"> <label>Beethoven's Cabin</label>
				...
				<div class="option active">
					<div class="row">
						<div class="col-12 col-md-3">
							<input type="radio" name="group2-roomoption" data-id="2" checked="checked" value="Chopin Cabin"> <label>Chopin Cabin</label>
