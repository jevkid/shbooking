		...
		<div class="col-12">
			<div class="hidden-section-header">
				<div class="row">
					...
					<div class="col-3 text-right"><button class="secondary show-extras" data-toggle="collapse" data-target="#group1-extras" aria-expanded="false">Hide Extras</button></div>
				</div>
			</div>
		</div>
	</div>
